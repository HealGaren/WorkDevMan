...
import kr.applepi.workdevman.LockScreen.AlarmSingleTon;
import kr.applepi.workdevman.LockScreen.LockService;
...
public class ServiceTool {
    ...
    public static boolean isServiceRunning(Context context) {
        ...
        for (ActivityManager.RunningServiceInfo runningServiceInfo : services) {
            if (runningServiceInfo.service.getClassName().equals("kr.applepi.workdevman.LockScreen.LockService")) {
                return true;
            }
        }
        return false;
