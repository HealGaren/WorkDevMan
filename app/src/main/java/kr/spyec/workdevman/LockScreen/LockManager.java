...
import kr.spyec.workdevman.HttpService.API.GitRepoDataService;
...
//    private AdRequest.Builder builder;
    ...
    public void init(Context context) {
        ...
        view.findViewById(R.id.btn_final_unlock).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                touchNum++;
                if(touchNum>200) removeView();
            }
        });
    ...
    private class NetTask extends AsyncTask<Void, Void, Long> {
        ...
        protected void onPostExecute(Long lastPushTime) {
            if (lastPushTime != null) {
                ...
                pushedTimeText.setText(String.format("%04d.%02d.%02d %02d:%02d", year, month+1, day, hour, minute));
                if (isTimeOver) {
